...
Corruption is one of the major issues in India and there are several reasons causing that problem. The obsolete political system, especially the lack of transparent laws and processes, forces the Indians to bribe employees of public institutions. It has not only a big effect on the economy, but also a big influence on the Indian’s lives, as we can see in a quote from an Indian citizen in an article about courruption in India of “The Guardian”: “Of the 40,000 rupees (£520) I earn a month from my restaurant, I pay at least a third in bribes.” Mostly every public authority requires bribes for their actually regular work. 
...
bribe_dep$dep = factor(bribe_dep$dep,levels(bribe_dep$dep)[c(8, 11, 15, 2, 9, 16, 5, 6, 3, 10, 14, 13, 4, 7, 17, 1, 12)])
...
am.count <- rbind(bribe_sta, data.frame(states = setdiff(ind.df$NAME_1, bribe_sta$states), amount = rep(0, 11)))

am.count <- am.count[-c(38),]
am.count <- am.count[-c(25),]
