---
title: "Assignment 2"
author: "Tor Jensen, Timo Klingler, Margaret Kuhn and Janette Wiget"
...
Accoring to the previous summary there does not seem to be any significant relation. We can only observe few outliers which are for medium-sized amounts. Consequently, we can assume that there must be other intervening factors that have a larger impact on these outliers other than size alone.
